...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('TASK_CREATED', 'TASK_STATUS_CHANGED', 'TASK_ASSIGNED', 'TASK_UPDATED', 'TASK_DELETED', 'PROJECT_CREATED', 'PROJECT_UPDATED', 'PROJECT_DELETED', 'COMMENT_ADDED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_STATUS_CHANGED', 'TASK_OVERDUE', 'PROJECT_UPDATED', 'GENERAL');
...
-- CreateIndex
CREATE INDEX "tasks_assignedDeveloperId_idx" ON "tasks"("assignedDeveloperId");
...
-- AddForeignKey
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_assignedDeveloperId_fkey" FOREIGN KEY ("assignedDeveloperId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
